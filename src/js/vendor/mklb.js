...
var mklbItems = document.getElementsByClassName('mklbItem');
var lightboxContainer;
var auto = 0;
var interval;


for (var i=0; i< mklbItems.length; i++) {
    (function(){
        var mklbItem = mklbItems[i];
...
function _mklbAddGallery(currentItem) {
    ...
    var mklbInner = document.createElement('div');
...
function _mklbSlide(slideToPrev) {
    var inner = document.getElementById('mklbInner');
    var elements = document.getElementsByClassName('imageContainer').length;
    var marginLeft = inner.style.marginLeft;
